...
@objc(NetworkingMultipeer) class NetworkingMultipeer: CDVPlugin, MCNearbyServiceAdvertiserDelegate, MCNearbyServiceBrowserDelegate, MCSessionDelegate {
    ...
    @objc(registerAdvertisingError:) func registerAdvertisingError(_ command: CDVInvokedUrlCommand) {
        self.idForAdvertisingError = command.callbackId
    }

    @objc(registerBrowsingError:) func registerBrowsingError(_ command: CDVInvokedUrlCommand) {
        self.idForBrowsingError = command.callbackId
    }

    @objc(registerFoundPeer:) func registerFoundPeer(_ command: CDVInvokedUrlCommand) {
        self.idForFoundPeer = command.callbackId
    }

    @objc(registerLostPeer:) func registerLostPeer(_ command: CDVInvokedUrlCommand) {
        self.idForLostPeer = command.callbackId
    }

    @objc(registerReceiveInvitation:) func registerReceiveInvitation(_ command: CDVInvokedUrlCommand) {
        self.idForReceiveInvitation = command.callbackId
    }

    @objc(registerReceiveData:) func registerReceiveData(_ command: CDVInvokedUrlCommand) {
        self.idForReceiveData = command.callbackId
    }

    @objc(registerChangeState:) func registerChangeState(_ command: CDVInvokedUrlCommand) {
        self.idForChangeState = command.callbackId
    }

    @objc(getLocalPeerInfo:) func getLocalPeerInfo(_ command: CDVInvokedUrlCommand) {
        ...
        let pluginResult = CDVPluginResult(status: CDVCommandStatus_OK, messageAs: [
            ...
            "hash": NSNumber(value: UInt32(bitPattern: Int32(truncatingIfNeeded: self.localPeerID.hash))),
        ])

        self.commandDelegate.send(pluginResult, callbackId: command.callbackId)
    }
    
    func initSession(_ displayName: String?) {
        if self.session != nil {
            return
        }
        ...
        print("Init session with displayName = " + displayName!)
    ...
    @objc(startAdvertising:) func startAdvertising(_ command: CDVInvokedUrlCommand) {
    ...
    @objc(stopAdvertising:) func stopAdvertising(_ command: CDVInvokedUrlCommand) {
        self.serviceAdvertiser?.stopAdvertisingPeer()
        self.serviceAdvertiser = nil
    ...
    @objc(startBrowsing:) func startBrowsing(_ command: CDVInvokedUrlCommand) {
        let pluginResult: CDVPluginResult
    ...
    @objc(stopBrowsing:) func stopBrowsing(_ command: CDVInvokedUrlCommand) {
        self.serviceBrowser?.stopBrowsingForPeers()
        self.serviceBrowser = nil
    ...
    @objc(invitePeer:) func invitePeer(_ command: CDVInvokedUrlCommand) {
        let pluginResult: CDVPluginResult
    ...
    @objc(acceptInvitation:) func acceptInvitation(_ command: CDVInvokedUrlCommand) {
        self.handleInvitation(command, accept: true)
    }

    @objc(declineInvitation:) func declineInvitation(_ command: CDVInvokedUrlCommand) {
        self.handleInvitation(command, accept: false)
    }

    @objc(disconnect:) func disconnect(_ command: CDVInvokedUrlCommand) {
        self.session.disconnect()
    ...
    @objc(getConnectedPeers:) func getConnectedPeers(_ command: CDVInvokedUrlCommand) {
    ...
    @objc(sendDataReliable:) func sendDataReliable(_ command: CDVInvokedUrlCommand) {
        self.sendData(command, withMode: .reliable)
    }

    @objc(sendDataUnreliable:) func sendDataUnreliable(_ command: CDVInvokedUrlCommand) {
